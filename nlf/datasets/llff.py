...
from utils.pose_utils import correct_poses_bounds
...
class LLFFDataset(Base5DDataset):
    ...
    def read_meta(self):
        ...
        self.poses, self.poses_avg, self.bounds = correct_poses_bounds(poses, self.bounds)
        ...
        self.directions = get_ray_directions_K(self.img_wh[1], self.img_wh[0], self.K, centered_pixels=True)
