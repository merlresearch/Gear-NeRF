...
class FocusVisualizer(BaseVisualizer):
    ...
    def validation(self, batch, batch_idx):
        ...
        rays = get_lightfield_rays(
            W, H, s, t, dataset.aspect, st_scale=self.st_scale, uv_scale=self.uv_scale, near=self.near, far=self.far
        ...
        tform = params[..., :-out_channels].reshape(-1, out_channels, param_channels)
